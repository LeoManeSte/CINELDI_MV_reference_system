...
print(f'Maximum load demand in the area (after scaling): {P_max:.3f} MW')

# %% Plot the aggregated load time series for the area
plt.figure()
plt.plot(load_time_series_subset_aggr)
plt.xlabel('Hour of year')
plt.ylabel('Load demand (MW)')
plt.title('Aggregated load demand for the area (buses {})'.format(bus_i_subset))
plt.grid()
plt.show()
